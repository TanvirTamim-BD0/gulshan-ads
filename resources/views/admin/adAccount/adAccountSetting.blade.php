...
@section('content')
    <h6 class="mb-0 text-uppercase">Ad Account Settings</h6> <br>

    <div class="card rounded-4 p-4">

        <div align="right">
                    <a href="{{route('ad-account-list')}}" class="btn btn-primary">Account List</a>
                </div>

                <div class="card-body">
                	<form action="{{route('ad-account-settings-submit')}}" method="post" enctype="multipart/form-data">
            		@csrf
