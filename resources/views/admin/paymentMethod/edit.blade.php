...
@section('content')
	 <h6 class="mb-0 text-uppercase">Update Payment Method</h6>
	<hr/>
	<div class="row">
		<div class="col-xl-8 mx-auto">		
			<div class="card">
              <div class="card-body">
                ...
                <form class="row g-3" action="{{route('payment-method.update',$paymentMethodData->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
