...
<h1>Edit Tiktok Ad Account</h1>
<h4>{{$adAccount->ad_name}}({{$adAccount->ad_account_number}})</h4>

        <form action="{{route('tiktok-update-ad-account',$adAccount->id)}}" method="post">
            @csrf
                    ...
                    <div class="row row-cols-1 row-cols-lg-1 row-cols-xl-1">  
                    	...
                    	<!-- <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{$adAccount->ad_name}}" name="ad_name" required>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{$adAccount->balance}}" name="balance" required>
                            </div>
                        </div>
                                ...
                                <input type="text" class="form-control" value="{{$adAccount->daily_limit}}" name="daily_limit" required>
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" value="{{$adAccount->payment_threshold}}" name="payment_threshold">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="date" class="form-control" value="{{$adAccount->monthly_billing_date}}" name="monthly_billing_date">
                                                </div>
                                            </div>
