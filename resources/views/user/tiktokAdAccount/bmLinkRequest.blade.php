...
@section('content')
	...
	<h1>Tiktok Ad Account BM Link Request</h1>

        <form action="{{route('tiktok-ad-account-bm-link-request-submit')}}" method="post">
            @csrf
            <div class="card rounded-4 p-5">
                <div class="card-body">
                    <div class="row row-cols-1 row-cols-lg-1 row-cols-xl-1">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <label class="form-label">BM Name</label>
                                <input type="text" class="form-control" name="bm_name" required>
                            </div>
                        </div>
